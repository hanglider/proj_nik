...
| `data/labeling_sample.csv` | Анонимизированная выборка из 1000 сообщений для ручной разметки |
...
```bash
.venv/bin/python scripts/prepare_labeling_sample.py --sample-size 1000
```
...
- размер выборки для разметки: `1000`.
